...
def get_idcg_list(label_vector, qptr, max_len):
    ...
    idcg_matrix = np.zeros((idcg_list.shape[0], max_documents)) + idcg_list[:, None]

    return idcg_matrix[np.arange(max_documents)[None, :] < n[:, None]]
